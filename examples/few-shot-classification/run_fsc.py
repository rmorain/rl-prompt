...
def main(config: "DictConfig"):
    ...
    (train_dataset, val_dataset, test_dataset, num_classes, verbalizers, template) = (
    ...
    reward = make_prompted_classification_reward(
        num_classes, verbalizers, template, config
    )
